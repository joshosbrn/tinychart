...
(function($) {
  ...
  function makeRequest (url, callback, params) {
    ...
    * @type {string}
    */
   $.jChartbeat.realTimeBaseUrl = 'https://api.chartbeat.com';

   /**
    * The base url that is prepended to all historical API requests
    * @type {string}
    */
   $.jChartbeat.historicalBaseUrl = 'https://chartbeat.com/dashapi';
...
$.jChartbeat.quickstats(function(value) {
  console.log(value);
  document.getElementById("concurrent-visits-counter").innerHTML = (value.people);
  document.getElementById("top-pages-visits-0").innerHTML = (value.toppages[0].visitors) + " visitors";
  document.getElementById("top-pages-path-1").innerHTML = (value.toppages[1].path);
  document.getElementById("top-pages-visits-1").innerHTML = (value.toppages[1].visitors) + " visitors";
  document.getElementById("top-pages-path-2").innerHTML = (value.toppages[2].path);
  document.getElementById("top-pages-visits-2").innerHTML = (value.toppages[2].visitors) + " visitors";
  document.getElementById("top-pages-path-3").innerHTML = (value.toppages[3].path);
  document.getElementById("top-pages-visits-3").innerHTML = (value.toppages[3].visitors) + " visitors";
  document.getElementById("top-pages-path-4").innerHTML = (value.toppages[4].path);
  document.getElementById("top-pages-visits-4").innerHTML = (value.toppages[4].visitors) + " visitors";
});

$.jChartbeat.toppages(function(value) {
  console.log(value);
  document.getElementById("story-title-0").innerHTML = (value[0].i);
  document.getElementById("top-pages-path-0").innerHTML = (value[0].path);
  document.getElementById("story-title-1").innerHTML = (value[1].i);
  document.getElementById("top-pages-path-1").innerHTML = (value[1].path);
  document.getElementById("story-title-2").innerHTML = (value[2].i);
  document.getElementById("top-pages-path-2").innerHTML = (value[2].path);
  document.getElementById("story-title-3").innerHTML = (value[3].i);
  document.getElementById("top-pages-path-3").innerHTML = (value[3].path);
  document.getElementById("story-title-4").innerHTML = (value[4].i);
  document.getElementById("top-pages-path-4").innerHTML = (value[4].path);
});
